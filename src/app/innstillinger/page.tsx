                  ...
                  {subscriptionStatus === 'trial' && (
                    <div style={{ background: 'rgba(255,107,0,0.08)', border: '1px solid rgba(255,107,0,0.2)', borderRadius: 12, padding: '14px 16px', marginBottom: 16, display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                      ...
                      <div>
                        ...
                        <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.5)' }}>Prøveperioden utløper om 5 dager. Legg til betaling for å fortsette.</p>
                      </div>
                    </div>
                  )}
                  ...
                  <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                      <div>
                        ...
                        <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.4)' }}>Varsle kun om deals med minst {minDiscount}% rabatt</p>
                      </div>
                ...
                <div style={{ padding: '20px 24px' }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    {AIRPORTS.map(({ code, name }) => {
                      const isActive = selectedAirports.includes(code)
                      return (
                        <div key={code} onClick={() => toggleAirport(code)}
                          style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 16px', borderRadius: 12, border: `1px solid ${isActive ? 'rgba(255,107,0,0.3)' : 'rgba(255,255,255,0.07)'}`, background: isActive ? 'rgba(255,107,0,0.06)' : '#242424', cursor: 'pointer', transition: 'all 0.15s' }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                            <div style={{ width: 36, height: 36, background: isActive ? '#ff6b00' : 'rgba(255,255,255,0.08)', borderRadius: 10, display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'background 0.15s' }}>
                              <span className="ms" style={{ fontSize: 18, color: isActive ? '#fff' : 'rgba(255,255,255,0.4)' }}>flight_takeoff</span>
                            </div>
                            <div>
                          ...
                          <div style={{ width: 22, height: 22, borderRadius: '50%', border: `2px solid ${isActive ? '#ff6b00' : 'rgba(255,255,255,0.15)'}`, background: isActive ? '#ff6b00' : 'transparent', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.15s' }}>
                            {isActive && <span className="ms" style={{ fontSize: 14, color: '#fff' }}>check</span>}
                          </div>
                        </div>
                      )
                    })}
